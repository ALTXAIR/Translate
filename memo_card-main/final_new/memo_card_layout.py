...
btn_Sleep = QPushButton('Відпочити') # кнопка забирає вікно та повертає його після закінчення таймера
...
RadioGroupBox.setLayout(layout_ans1) # готова "панель" с варіантами відповідей 
...
lb_Correct = QLabel('') # а тут буде написано текст правильної відповіді
...
layout_line2 = QHBoxLayout() # Запитання
...
layout_line1.addWidget(QLabel('Хвилин')) # нам не потрібна змінна для цього надпису
